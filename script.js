  ...
  const printStyles = `
    <style>
      @media print {
        ...
        .student-profile-print { display: block !important; visibility: visible !important; width: 100%; margin: 0; padding: 20px; background: white; }
  ...
  const printContent = `
    ...
    <div class="student-profile-print">
      ...
      <div class="profile-section">
        ...
        <p><strong>Strong Subjects:</strong> <span class="strong-subject">${student.strongSubject.join('</span> <span class="strong-subject">')}</span></p>
        <p><strong>Weak Subjects:</strong> <span class="weak-subject">${student.weakSubject.join('</span> <span class="weak-subject">')}</span></p>
        <table>
          <thead>
            <tr>
              <th>SUBJECT</th>
