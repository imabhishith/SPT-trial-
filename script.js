...
function openPrintWindow(title, content) {
  ...
  <style>
  /* ========================================
   ENHANCED STUDENT PROFILE PRINT STYLES
   ======================================== */

/* Modern Print Window with Professional Design */
@media print {
    ...
    /* Enhanced Print Content Container */
    .print-content {
        visibility: visible;
        display: block;
        position: relative;
    ...
    /* Student Profile Report Specific Styles */
    ...
    .profile-section table tbody tr:nth-child(odd) td {
        background: #f9fafb;
    }

    .profile-section table tbody tr:hover td {
        background: #eff6ff;
    }

    .profile-section table tbody tr:last-child td {
        border-bottom: none;
    }

    /* Highlight Strong/Weak Subjects */
    .profile-section span[style*="green"] {
        background: #d1fae5;
    ...
    .profile-section span[style*="red"] {
        background: #fee2e2;
    ...
    .profile-section:last-of-type h3 {
        color: #92400e;
        border-bottom-color: #f59e0b;
    }

    .profile-section:last-of-type p {
        color: #78350f;
        font-weight: 500;
    }
...
/* Enhanced inline print styles for direct printing */
.student-profile-print-inline {
    font-family: 'Inter', 'Segoe UI', Arial, sans-serif;
    max-width: 1000px;
    margin: 0 auto;
    background: white;
...
.student-profile-print-inline .print-header {
    background: linear-gradient(135deg, #2563eb 0%, #7c3aed 50%, #ec4899 100%);
    padding: 32px 24px;
    border-radius: 12px 12px 0 0;
    text-align: center;
...
.student-profile-print-inline .print-header h1 {
    font-size: 28pt;
    font-weight: 800;
    color: white;
    margin: 12px 0 8px 0;
...
.student-profile-print-inline .profile-section {
    background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%);
    border: 2px solid #e0e7ff;
    border-radius: 12px;
    padding: 24px;
...
.student-profile-print-inline .profile-section h3 {
    font-size: 16pt;
    font-weight: 700;
    color: #1e40af;
    margin: 0 0 16px 0;
...
.student-profile-print-inline table {
    width: 100%;
    border-collapse: separate;
    border-spacing: 0;
    border-radius: 8px;
...
.student-profile-print-inline table thead {
    background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%);
}

.student-profile-print-inline table th {
    padding: 14px 12px;
    color: white;
    font-weight: 700;
    text-align: left;
...
.student-profile-print-inline table td {
    padding: 12px;
    border-bottom: 1px solid #e5e7eb;
    background: white;
}

.student-profile-print-inline table tbody tr:nth-child(odd) td {
    background: #f9fafb;
}
  .print-content {
